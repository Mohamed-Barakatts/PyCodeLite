...
# icon
image_icon=PhotoImage(file="PyCodeLite/logo.png")
...
# buttons
Open = PhotoImage(file="PyCodeLite/open.png")
Save = PhotoImage(file="PyCodeLite/save.png")
Run = PhotoImage(file="PyCodeLite/run.png")
